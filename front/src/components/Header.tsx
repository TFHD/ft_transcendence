    ...
    <header>
      <nav>
        <ul className="flex gap-4 p-4 bg-gray-200">
          ...
          <li className="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition"><Link to="/login">Login</Link></li>
          <li className="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition"><Link to="/userslist">Liste</Link></li>
        </ul>
      </nav>
    </header>
  );
